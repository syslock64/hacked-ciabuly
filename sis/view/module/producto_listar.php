...
<div class="col-md-4" id="producto_categoria">
	...
	<select class="form-control" onchange="filtrarPoductos(this.value)">
		<option value="0">Todos</option>
		<?php while ($colc = mysqli_fetch_assoc($resultCat)){ ?>
		<option value="<?php echo $colc['categoria_id']; ?>" <?php if($colc['categoria_id']==$_GET['cat']){echo 'selected';} ?>><?php echo $colc['categoria_nombre']; ?></option>
		<?php } ?>
	</select>
