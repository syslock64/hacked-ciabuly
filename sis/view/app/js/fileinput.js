...
(function (factory) {
    ...
    tIcon = '<span class="glyphiconHJ glyphicon-fileHJ kv-caption-iconHJ"></span>';
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphiconHJ glyphicon-folder-openHJ"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="glyphiconHJ glyphicon-trashHJ"></i>',
